...
class TwitterClient(object):
    ...
    def __init__(self):
        ...
        consumer_key = '0gIXi6GQnMEknwTd3a7FQuMm1'
        consumer_secret = 'AptRacZbc1TonM2bnQTHGmFyE5tfkf6il5vm2i4WXis8UKZKET'
        access_token = '702477818-F49PMtraKByjKsej1yH1vLx5QbzsG3jC4EKX5KuQ'
        access_token_secret = '7Z82Jybht53Fyk17EXsGu2EadPwA2rnLXVO4X6MwSLCap'
        try:
            # creating object
    ...
    def emotion_finder(self, sentence):
        ...
        surprise = ["shock", "thunderbolt", "bombshell", "revelation", "eye-opener","pleasantly", "shocker","surprised", "upgrade"]
